  ...
  return (
    <main className="px-6 py-4 w-full max-w-[800px] mx-auto">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl
       max-w-md w-full border border-gray-200 mx-auto mb-8">
        <h2 className="text-3xl font-extrabold text-gray-800 mb-8
        text-center">Search Google Books</h2>
        <form onSubmit={handleSearchSubmit} className="space-y-6">
          <div>
            <label htmlFor="searchBookTitle" className="block text-sm
            font-medium text-gray-700 mb-1">Book Title</label>
            <input
              type="text"
              id="searchBookTitle"
          ...
          <div className="mt-8 border-t border-gray-200 pt-6">
            ...
            <ul className="space-y-4">
              {books.map((book, index) => (
                <li key={book.title + book.author + index} className="p-4 border
                 border-gray-200 rounded-lg shadow-sm flex items-start space-x-4">
...
const BookList: React.FC = () => {
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-blue-500 text-white rounded-lg
           shadow hover:bg-blue-600 focus:outline-none
  ...
  const genreColors = {
    Fiction: 'bg-blue-200 hover:bg-blue-300 border-blue-400',
    Fantasy: 'bg-red-200 hover:bg-red-300 border-red-300',
    'Science Fiction': 'bg-purple-200 hover:bg-purple-300 border-purple-400',
    default: 'bg-gray-100 hover:bg-gray-200 border-gray-300',
  }
          ...
          {books.map((book) => (
            ...
            >
              ...
              <div className="flex items-center">
                <strong className="text-gray-700 mr-1">Rating:</strong>
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`w-5 h-5 ${i < book.rating ? 'text-gray-400' : 'text-gray-300'}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
